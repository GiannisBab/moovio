...
import { Add01Icon, Cancel01Icon, Gps01Icon, Loading02Icon, Maximize01Icon, MinusSignIcon } from "@hugeicons/core-free-icons";
        ...
        <ControlGroup>
          ...
          >
            {waitingForLocation ? (
              ...
              <HugeiconsIcon icon={Gps01Icon} className="size-4" />
            )}
          </ControlButton>
        </ControlGroup>
      )}
